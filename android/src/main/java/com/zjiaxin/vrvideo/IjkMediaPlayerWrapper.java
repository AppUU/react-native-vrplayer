...
public class IjkMediaPlayerWrapper implements IMediaPlayer.OnPreparedListener {
...
//            player.setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "mediacodec", 1);
            player.setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "mediacodec_mpeg4", 1);//视频编码H264
//            player.setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "soundtouch", 1);//声调问题
//            player.setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "mediacodec-auto-rotate", 1);
    ...
    public void openFromRaw(Context context, Uri uri) {
        try {
